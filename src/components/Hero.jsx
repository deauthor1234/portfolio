...
const Hero = () => {
    return (
        <header className="container-wrapper relative h-[100vh] min-h-[40rem] bg-linear-to-b from-transparent to-gray-200" id="intro">
            <div className="flex justify-between container gap-16 items-center">
                ...
                <div className="min-w-[25rem] min-h-[25rem] rounded-r-4xl relative rotate-y-180 overflow-hidden">
                    <img src={profile2} alt="profile" className="size-full object-cover scale-125 absolute" data-aos="zoom-out" />
                </div>
            </div>
            <Link to="about" smooth={true} className="animate-bounce cursor-pointer size-16 flex justify-center items-center shadow-2xl text-xl rounded-full absolute bg-white bottom-8 left-[50%] translate-x-[-50%]">
