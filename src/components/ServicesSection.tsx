...
const ServicesSection = () => {
    return (
        <section id="services" className="container-wrapper py-24 max-[426px]:py-16 bg-gray-100">
            <div className="container">
                <h2 className="section-heading" data-aos="fade-right">WHAT CAN I DO?</h2>
                <div className="grid grid-cols-3 max-[1025px]:grid-cols-2 max-[740px]:grid-cols-1 max-[740px]:gap-10 gap-10 max-[1150px]:gap-6 max-[426px]:gap-5 mt-16 mb-14 max-[426px]:my-10 items-start">
