        ...
        <section className="container-wrapper" id="about">
            <div className="container flex justify-between items-center gap-16">
                ...
                <div className="size-full">
                    ...
                    <h3 className="text-xl font-bold" data-aos="fade-right">Languages:</h3>
                    ...
                    <h3 className="text-xl font-bold" data-aos="fade-right">Frameworks:</h3>
                    <div className="flex mt-4 mb-8 font-medium about-tech-stack gap-4 flex-wrap">
                    ...
                    <h3 className="text-xl font-bold" data-aos="fade-right">Design Tools:</h3>
                    <div className="flex mt-4 mb-8 font-medium about-tech-stack gap-4 flex-wrap">
                    ...
                    <h3 className="text-xl font-bold" data-aos="fade-right">Deployment Tools:</h3>
                    <div className="flex mt-4 mb-8 font-medium about-tech-stack gap-4 flex-wrap">
